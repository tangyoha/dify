const translation = {
  ...
  analysis: {
    ...
    responseTimeTrend: {
      title: '响应时间趋势',
      explanation: '显示每日平均响应时间的变化趋势，通过总响应时间除以消息数计算得出，帮助监控系统性能表现。',
    },
    userFeedbackTrend: {
      title: '用户反馈趋势',
      explanation: '显示用户对消息的点赞和点踩数量变化趋势，帮助了解用户满意度的变化。',
      like: '点赞数',
      dislike: '点踩数',
      likeTitle: '用户点赞趋势',
      likeExplanation: '显示用户对消息的点赞数量变化趋势，反映用户对回答的满意程度。',
      dislikeTitle: '用户点踩趋势',
      dislikeExplanation: '显示用户对消息的点踩数量变化趋势，帮助识别需要改进的问题。',
    },
  },
  userAnalytics: {
    title: '用户分析',
