const translation = {
  ...
  analysis: {
    ...
    responseTimeTrend: {
      ...
      explanation: 'Shows the daily average response time trend, calculated by dividing total response time by message count, helping monitor system performance.',
    },
    userFeedbackTrend: {
      title: 'User Feedback Trend',
      explanation: 'Shows the trend of user likes and dislikes on messages, helping understand changes in user satisfaction.',
      like: 'Likes',
      dislike: 'Dislikes',
      likeTitle: 'User Like Trend',
      likeExplanation: 'Shows the trend of user likes on messages, reflecting user satisfaction with responses.',
      dislikeTitle: 'User Dislike Trend',
      dislikeExplanation: 'Shows the trend of user dislikes on messages, helping identify areas for improvement.',
    },
  },
  userAnalytics: {
    ...
    userDistribution: 'User Activity Distribution',
    userDetails: 'User Details',
    userId: 'User ID',
    conversations: 'Conversations',
    messages: 'Messages',
    lastActive: 'Last Active',
    userRanking: 'User Activity Ranking',
  },
}
