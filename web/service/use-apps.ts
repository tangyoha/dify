...
export const useAppResponseTimeTrend = (appId: string, params?: DateRangeParams) => {
  return useAppStatisticsQuery<AppStatisticsResponse>('response-time-trend', appId, params)
}

export const useAppDailyFeedback = (appId: string, params?: DateRangeParams) => {
  return useAppStatisticsQuery<AppStatisticsResponse>('daily-feedback', appId, params)
}
