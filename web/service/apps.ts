...
export const getAppDailyFeedback: Fetcher<AppDailyFeedbackResponse, { url: string; params: Record<string, any> }> = ({ url, params }) => {
  return get<AppDailyFeedbackResponse>(url, { params })
}
